                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample05">
                        <div class="nav-table">
                            ...
                            <div class="dropdown">
                                <button class="btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle show" type="button" data-bs-toggle="dropdown"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-theme-text">
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="./infoUsuario.html">Mi cuenta</a>
                                            </button>
                                        </li>
                                        <li>
                                            <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="" aria-pressed="false">
                                            <a class="dropdown-item" href="#" onclick="cierreSesion()">Cerrar sesión</a>
                                            </button>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample05">
                        ...
                        <div class="iconoSuperior media" style="margin-right:4rem">
                            <ul class="d-flex list-unstyled me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown custom-row">

            ...
            `
                    ...
                    <div class="col" style="margin-bottom: 1rem;">
                        <div class="card card__team h-100">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal${prod.id}" style="width:100px; margin: 15px;">
                            Ver más <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
